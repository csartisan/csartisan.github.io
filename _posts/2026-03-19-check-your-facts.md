...
When I brought up AI with Mr. Skinner and my second source, Drew Lansford, a creative writing student with a knack for research, for their responses were somewhat differing: “If AI is collecting sources and then summarizing them for you.” Skinner claims, “What if the sources they’re getting are not valid? Lets say me and you create a website called [thenews.com](http://thenews.com), and all we do is spread false information, but no one knows yet. AI could pick up our information and say, according to this source, candy prevents diabetes.” 
